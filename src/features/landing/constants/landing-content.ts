...
export const LANDING_FEATURES = [
  ...
  },
  {
    ...
    description:
      "핵심 용어를 빈칸으로 바꾸고, 답을 입력하면 즉시 채점해요. 에빙하우스 망각 곡선에 맞춰 복습 주기도 자동으로 조절됩니다.",
    bullets: [
      "PDF에서 빈칸 자동 추출",
      "직접 답 입력·즉시 채점",
      "3단계 자신감 평가",
      "간격 반복(Spaced Repetition) 자동 적용",
      "오답은 다음 세션에 자동 재출제",
    ],
  },
] as const
...
export const LANDING_PRICING_PLANS: LandingPricingPlan[] = [
  {
    ...
    features: [
      { text: "PDF 5개/월", included: true },
      { text: "설명 10회/월", included: true },
      { text: "빈칸 50개/월", included: true },
      { text: "폴더 관리", included: false },
      { text: "퀴즈 생성", included: false },
      { text: "AI 튜터", included: false },
    ],
    cta: "무료로 시작",
    variant: "outline",
  },
  ...
  },
  {
    ...
    description: "AI 튜터와 함께 심화 학습이 필요할 때.",
    features: [
      { text: "Pro의 모든 기능", included: true },
      { text: "AI 튜터 무제한", included: true },
      { text: "팀 공유 (최대 5명)", included: true },
      { text: "학습 패턴 분석", included: true },
