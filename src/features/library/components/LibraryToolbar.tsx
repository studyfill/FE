...
import { PdfUploadButton } from "@/features/library/components/PdfUploadButton"
import { cn } from "@/lib/utils"
import type { Folder, UserFileSort, UserFileViewLayout } from "@/types/user-file"

const SORT_OPTIONS: { value: UserFileSort; label: string }[] = [
...
type LibraryToolbarProps = {
  folderPath: Folder[]
  sort: UserFileSort
  viewLayout: UserFileViewLayout
  onSortChange: (sort: UserFileSort) => void
  onViewLayoutChange: (layout: UserFileViewLayout) => void
...
export const LibraryToolbar = ({
  ...
  const handleSortSelect = (value: UserFileSort) => {
    onSortChange(value)
    setSortOpen(false)
  }
                  ...
                  <span key={folder.id} className="contents">
                    ...
                    <BreadcrumbItem>
                      {isLast ? (
                        ...
                        <BreadcrumbLink
                          render={
                            <Link href={ROUTES.libraryFolder(folder.id)} />
                          }
                          className="text-muted-foreground hover:text-foreground"
                        >
                          {folder.name}
