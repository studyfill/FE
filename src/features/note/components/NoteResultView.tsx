...
import { EditableText } from "@/features/note/components/EditableText"
import { NoteGenerateIcon } from "@/features/note/components/NoteGenerateIcon"
import { TextFormatToolbar } from "@/features/note/components/TextFormatToolbar"
import { NoteEditProvider } from "@/features/note/context/NoteEditContext"
import type { LectureNote } from "@/types/note"

type NoteResultViewProps = {
  data: LectureNote
...
export const NoteResultView = ({
  ...
  >
    <NoteDocument data={data} onSourceClick={onSourceClick} />
  </NoteEditProvider>
)
